...
class Config(object):
    ...
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID")) if os.environ.get("TECH_VJ_API_ID") else None
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID")) if os.environ.get("TECH_VJ_OWNER_ID") else None
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL")) if os.environ.get("TECH_VJ_LOG_CHANNEL") else None
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = os.environ.get('TECH_VJ_UPDATES_CHANNEL', '') # your update channel id and make bot admin in update channel with full right
    ...
    TECH_VJ = bool(os.environ.get('TECH_VJ', False)) # Set False If you want shortlink off else True
